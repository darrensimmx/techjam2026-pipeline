...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-08-31 21:46 | `cfd6841` | `worktree-ps4-compliance-check` | **0.872057** | +0.179471 | +0.765347 | 0.9950 | 0.705855 | 2.86 | [both -> leaky] PS4 spec compliance verification [dataset: public_set.jsonl] |
