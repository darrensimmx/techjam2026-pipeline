...
short-circuit despite scoring marginally higher. Ask-yield (Phase 3) replaces
...
def next_attribute(state: SessionState) -> str | None:
    ...
    Takes the whole `state`, not just the asked list, so Phase 3 (ask-yield)
    ...
    when building Phase 3; do not widen this signature again.
    """
